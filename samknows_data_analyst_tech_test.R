...
## 1 - Set up your environment: load any relevant packages for reshaping data, joining, visualization, and handling datetimes, and set your working directory
##
...
##
##   download_measurements.csv - contains the results of download speed tests for some of our volunteers
...
##
##   upload_measurements.csv - contains the results of upload speed tests for some of our volunteers
##      person_id: identifier for each person in our dataset
##      time_of_measurement: when the test was run (in UTC)
##      measured_download_speed_in_Mbps: what downstream speed was measured
##      did_test_complete_successfully: TRUE if the test completed successfully, FALSE if the test encountered a problem
...
##     person_id: identifier for each person in our dataset
##     country: the country where the person's connection is located
##     city: the city where the person's connection is located
##     type_of_broadband_connection: either ADSL (slow; download speed < 25 Mbps), VDSL (download speed generally less than 100 Mbps),
##                                   or Fibre to the premises (speeds can be very fast; up to 1000 Mbps)
...
##      only contains people in the country 'Countrydonia' (i.e. put a filter on the details_for_each_person table)
...
##      only contains tests from the month of June 2019 (i.e. put a filter on time_of_measurement)
##
