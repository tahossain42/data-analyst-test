...
simulated_allocations <- simulated_data %>%
...
write_csv(simulated_allocations, "details_for_each_person.csv", na = "")
write_csv(simulated_download_tests, "download_speed_measurements.csv", na = "")
write_csv(simulated_upload_tests, "upload_speed_measurements", na = "")
